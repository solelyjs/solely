export interface RouteConfig {
     ...
     */
    component?: () => Promise<string | { tagName: string }>;
...
export interface RouteMatch {
    ...
    meta: Record<string, unknown>; // 快捷方式（可选）：方便直接获取最深层的路由
}

export interface NavigationGuard {
    (to: RouteMatch, from: RouteMatch | null): boolean | Promise<boolean> | string;
}
